<?php
// admin_modules/admin_all_submissions.php
// NOTE: admin.php wraps this file in <div id="tab-submissions" class="tab-content">
// DO NOT add any div with id="tab-submissions" inside this file - it causes the freeze.
