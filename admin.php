...
<body>
    ...
    <script>
        ...
        function viewFullSubmission(sub){let content='<h3>'+sub.task_title+'</h3>';content+='<p><strong>Student:</strong> '+sub.student_name+' ('+sub.student_email+')</p>';content+='<p><strong>Submitted:</strong> '+sub.submitted_at+'</p>';if(sub.submission_text){content+='<p><strong>Description:</strong><br>'+sub.submission_text.replace(/\n/g,'<br>')+'</p>';}if(sub.github_link){content+='<p><strong>GitHub:</strong> <a href="'+sub.github_link+'" target="_blank">'+sub.github_link+'</a></p>';}if(sub.submission_url){content+='<p><strong>URL:</strong> <a href="'+sub.submission_url+'" target="_blank">'+sub.submission_url+'</a></p>';}alert(content);}
