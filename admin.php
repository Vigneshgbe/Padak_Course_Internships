...
$statsRes = $db->query("SELECT 
    ...
    (SELECT COUNT(DISTINCT student_id) FROM students WHERE status='active') as total_students
");
...
$studentsRes = $db->query("SELECT id, full_name, email FROM students WHERE status='active' ORDER BY full_name");
$students = [];
...
<body>
            ...
            <div class="section">
                ...
                <div class="section-body">
                    ...
                    <div class="filter-bar">
                        <a href="?filter=active" class="filter-btn <?php echo $filterStatus==='active'?'active':''; ?>">
                            Active (<?php echo count(array_filter($tasks, fn($t)=>$t['status']==='active')); ?>)
                        </a>
                        <a href="?filter=archived" class="filter-btn <?php echo $filterStatus==='archived'?'active':''; ?>">
                            Archived
                        </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br><small style="color:var(--text3);">
                                            <i class="fas fa-user fa-xs"></i> Assigned to specific student
                                        </small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge badge-<?php echo $task['task_type']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <br><small style="color:var(--blue);">
                                            <i class="fas fa-hourglass-half"></i> <?php echo $task['pending_count']; ?> pending
                                        </small>
                                        <?php endif; ?>
                                        <?php else: ?>
                    ...
                    <div class="sub-card">
                            ...
                            <div>
                                ...
                                <div class="sub-meta">
                                    ...
                                    <span class="sub-meta-item">
                                        ...
                                        <?php echo date('M d, Y g:i A', strtotime($sub['submitted_at'])); ?>
                                    </span>
                                    <span class="sub-meta-item">
                                        <i class="fas fa-star"></i>
                                        Max: <?php echo $sub['max_points']; ?> pts
                                    </span>
                                </div>
                            </div>
                        ...
                        <div style="margin-bottom:10px;">
                            ...
                            <a href="<?php echo htmlspecialchars($sub['github_link']); ?>" target="_blank" 
                               style="color:var(--blue);font-size:.82rem;word-break:break-all;">
                        ...
                        <div style="margin-bottom:10px;">
                            ...
                            <a href="<?php echo htmlspecialchars($sub['submission_url']); ?>" target="_blank" 
                               style="color:var(--blue);font-size:.82rem;word-break:break-all;">
                        ...
                        <div style="margin-bottom:10px;">
                            ...
                            <a href="<?php echo htmlspecialchars($sub['file_path']); ?>" download 
                               style="color:var(--blue);font-size:.82rem;">
                        ...
                        <div class="sub-actions">
                            <button class="btn btn-primary btn-sm" 
                                    onclick='reviewSubmission(<?php echo json_encode($sub); ?>)'>
                                <i class="fas fa-clipboard-check"></i> Review
                            </button>
                            <button class="btn btn-secondary btn-sm" 
                                    onclick='viewFullSubmission(<?php echo json_encode($sub); ?>)'>
            ...
            <form method="POST" id="taskForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="task_title" class="form-input" 
                               placeholder="e.g., Build a React Calculator App" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Description</label>
                        <textarea name="description" id="task_description" class="form-textarea" 
                                  placeholder="Detailed task requirements, deliverables, and instructions..."></textarea>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="max_points" id="task_points" class="form-input" 
                        ...
                        <div class="form-group full">
                            ...
                            <input type="url" name="resources_url" id="task_resources" class="form-input" 
                                   placeholder="https://docs.example.com/task-guide">
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="points_earned" id="review_points" class="form-input" 
                               min="0" placeholder="Leave blank if not approving">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="feedback" id="review_feedback" class="form-textarea" 
                                  placeholder="Provide constructive feedback to the student..." style="min-height:120px;"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        function reviewSubmission(sub) {
            ...
            const info = `
                <strong style="font-size:.95rem;">${sub.task_title}</strong><br>
        ...
        function viewFullSubmission(sub) {
            let content = '<h3>' + sub.task_title + '</h3>';
            content += '<p><strong>Student:</strong> ' + sub.student_name + ' (' + sub.student_email + ')</p>';
            content += '<p><strong>Submitted:</strong> ' + sub.submitted_at + '</p>';
            if (sub.submission_text) {
                content += '<p><strong>Description:</strong><br>' + sub.submission_text.replace(/\n/g, '<br>') + '</p>';
            }
            if (sub.github_link) {
                content += '<p><strong>GitHub:</strong> <a href="' + sub.github_link + '" target="_blank">' + sub.github_link + '</a></p>';
            }
            if (sub.submission_url) {
                content += '<p><strong>URL:</strong> <a href="' + sub.submission_url + '" target="_blank">' + sub.submission_url + '</a></p>';
            }
            alert(content); // In production, use a proper modal
        }
